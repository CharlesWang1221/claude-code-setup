...
**發布前品牌三關（產完 fb-post.txt / ig-caption.txt 後跑一次，不用外顯輸出但要確認過）**
1. 語氣關：像不像老查本人的節奏用詞，不是「賦能」「全方位整合」那種報告腔
2. 事實關：逐句檢查有沒有說過頭、亂補、沒證據——沒在逐字稿或老查原話裡出現的數字/案例/成效，一個字不能寫
3. 禁區層：絕對句（保證、第一、最有效）一律降級或拿掉；沒被交代的承諾（限時優惠、退費保證）不自己加
