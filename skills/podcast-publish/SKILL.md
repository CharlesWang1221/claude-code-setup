...
YouTube 縮圖是獨立交付物，不把正片第一幀直接當縮圖。每集在正片渲染前先產出 16:9、1920 × 1080 縮圖：

- 使用本集主題視覺與角色，主標 6 至 10 個中文字，不能只是照抄影片標題。
- 主標比副標大至少 20%，加深色陰影或描邊，確保縮小到手機尺寸仍清楚。
